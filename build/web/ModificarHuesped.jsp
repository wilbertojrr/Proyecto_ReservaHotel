...
<html lang="es">
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <form action="SvModificarHuesped" method="GET">
              ...
              Huesped hues = (Huesped) misesion.getAttribute("huesped");
              Date fecha = hues.getFecha_nac();
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input name="dni" type="text" class="form-control" id="dni" value="<%=hues.getDni()%>" required autocomplete="off">
    </div>
    <div class="form-group col-md-6">
      <label for="nombre">Nombre:</label>
      <input type="text" class="form-control" id="nombre" name="nombre" value="<%=hues.getNombre()%>" required autocomplete="off">
    </div>
      </div>
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="apellido" name="apellido" value="<%=hues.getApellido()%>" required autocomplete="off">
    </div>
    <div class="form-group col-md-6">
      <label for="fecha_nac">Fecha de nacimiento:</label>
      <input type="date" class="form-control" id="fecha_nac" name="fecha_nac" value="<%=fechaComoCadena%>" required autocomplete="off">
    </div>
            </div>
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="direccion">Dirreccion:</label>
      <input type="text" class="form-control" id="direccion" name="direccion" value="<%=hues.getDireccion()%>" required autocomplete="off">
    </div>
    <div class="form-group col-md-6">
      <label for="profesion">Profesion:</label>
      <input type="text" class="form-control" id="profesion" name="profesion" value="<%=hues.getProfesion()%>" required autocomplete="off">
    </div>
        </div>
    <input type="hidden" name="id" value="<%=hues.getId_persona()%>" required autocomplete="off">
    <%}%>
