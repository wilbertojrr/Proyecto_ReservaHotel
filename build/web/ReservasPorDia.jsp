...
<html lang="en">
  ...
  <thead>
    <tr>
      <th scope="col">Buscar Reserva:</th>
    </tr>
  </thead>
  <tbody>
    <tr>
        <td> 
            <form name="buscarFecha" action="SvReservaPorDia" method="POST" style="display:inline">

                
                    <input type="date" name="fechaBuscar" required autocomplete="off" >

                    <button type="submit" class="btn btn-primary" style="display:inline">Buscar</button>
            </form>
        </td>
