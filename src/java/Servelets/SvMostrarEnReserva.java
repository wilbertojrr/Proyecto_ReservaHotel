 ...
 * @author wilbe
 */
@WebServlet(name = "SvMostrarEnReserva", urlPatterns = {"/SvMostrarEnReserva"})
public class SvMostrarEnReserva extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       Controladora control = new Controladora();
        ...
        misesion.setAttribute("listaHabitacion", listaHabitacion);
